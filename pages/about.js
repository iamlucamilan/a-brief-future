...
function About({  }) {
  ...
  return (
    <div className="container about">
        ...
        <p>
          We enjoy this sort of brain teaser and appreciate it if you do too. <br/>Please contact us for any sort of feedback, unnecessary comments, collaboration requests or serious wedding proposals. <br/>We do <a href="mailto:hq@alterneeringstudios.com&subject=Yo!&body=Hello email sender, we appreciate you. Did you enjoyed the sun lately?">email</a> but prefer Instagram at <a href="https://www.instagram.com/alterneeringstudios" target="_blank">@alterneeringstudios</a>
        </p>
        <p>
